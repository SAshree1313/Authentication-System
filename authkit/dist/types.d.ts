...
export type CredentialCreateOptionsFromServer = any;
export type AssertionOptionsFromServer = any;
export type RegisterBeginResponse = {
    options: CredentialCreateOptionsFromServer;
    challengeId: string;
};
...
export type LoginBeginResponse = {
    options: AssertionOptionsFromServer;
    challengeId: string;
};
...
export type RecoveryBeginResponse = {
    challengeId: string;
    success: boolean;
};
